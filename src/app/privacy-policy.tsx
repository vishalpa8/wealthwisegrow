  ...
  return (
    <section className="max-w-3xl mx-auto p-8 mt-8 bg-white rounded-2xl shadow-lg border border-gray-100">
      ...
      <p className="mb-4 text-gray-700">
        <strong>WealthWise Hub</strong> is committed to protecting your privacy. This policy explains how we collect, use, and safeguard your information.
      </p>
      ...
      <p className="mb-2 text-gray-700">For questions or concerns, please contact us at <a href="mailto:contact@wealthwisehub.com" className="text-blue-600 underline">contact@wealthwisehub.com</a>.</p>
