    ...
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {filteredCalculators.map((calculator) => (
          ...
          >
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-lg hover:border-gray-200 transition-all duration-200 p-5 h-[220px] flex flex-col">
              {/* Header with Icon and Badge */}
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center space-x-3">
                  <div className="text-2xl">{calculator.icon}</div>
                  {calculator.popular && (
                    <span className="bg-yellow-100 text-yellow-800 text-xs font-medium px-2 py-1 rounded-md">
                      Popular
                    </span>
                  )}
                </div>
              ...
              <div className="flex items-center gap-2 mt-auto">
                ...
                <span className={`text-xs font-medium px-2 py-1 rounded-md ${getDifficultyColor(calculator.difficulty)}`}>
